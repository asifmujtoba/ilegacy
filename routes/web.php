...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['middleware' => 'can:isAdmin'], function () {
        ...
        Route::get('/reports/attendance', [ReportController::class, 'attendanceReports'])->name('reports.attendanceReports');
        Route::get('/reports/caller-reports', [ReportController::class, 'callerReports'])->name('reports.callerReports');
