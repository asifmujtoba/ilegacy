...
Route::group(['middleware' => 'auth:web'], function () {
    ...
    Route::get('/users/getattendance', [UserController::class, 'getAttendance'])->name('users.getAttendance');
    Route::get('/users/registerattendance', [UserController::class, 'registerAttendance'])->name('users.registerAttendance');
